...
const tablero = document.querySelectorAll('.spot');
const print = document.querySelector("#chartContainer");
let turn = true;


const printX = (spaceblank) => {
    const htmlPrint = `
...
print.addEventListener('click', (e) => {
    ...
    turn == true ? printX(space) : printO(space);
    toggleTurn();
})
